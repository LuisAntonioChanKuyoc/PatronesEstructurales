...
namespace PatronBridge.Transporte
{
    class Tren : ITipoEnvio
    {
        ...
        {
            Console.WriteLine("El paquete se ha cargado en el Tren.");
        }
        ...
        public void enviar()
        {
            Console.WriteLine("El Tren ha salido con el paquete.");
        }
        ...
        {
            Console.WriteLine("El Tren ha llegado al destino y se ha descargado.");
        }
